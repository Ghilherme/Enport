...
export const HISTORIA: Historia[] = [
    {id:0, frase: "1 -Regina!!!, REGINA!!!^500 eu gritava as 21:34 da noite.", iddecisao:1},
    {id:1, frase: "2 - Escolheu botão 1", iddecisao:1},
    {id:1, frase: "2 - Escolheu botão 2", iddecisao:2},
    {id:2, frase: "3 - Voltando a história,^300 eu fui jogar futebol na rua de trás e a minha família está na cidade vizinha visitando os meus avós.^500 O combinado era que eu voltasse para casa até 21:30,^300 tomasse banho e deitasse.", iddecisao:1},
    {id:3, frase: "4 - Meus pais vão chegar as 22h e querem me ver dormindo ou pelo menos fingindo.^500 O problema é que eu perdi as chaves de casa mais uma vez e as casas da Rua São Simão estão todas fechadas e com as luzes apagadas. ", iddecisao:1},
    {id:4, frase: "5 - Escolheu botão 1 ", iddecisao:1},
    {id:4, frase: "5 - Escolheu botão 2 ", iddecisao:2},
    {id:4, frase: "5 - Escolheu botão 3 ", iddecisao:3},
